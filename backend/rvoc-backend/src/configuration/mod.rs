...
pub struct Configuration {
    ...
    #[clap(long, default_value = "1", conflicts_with = "config_file")]
    ...
    #[clap(long, default_value = "localhost", conflicts_with = "config_file")]
    pub mongodb_host: String,

    #[clap(long, default_value = "27017", conflicts_with = "config_file")]
    pub mongodb_port: u16,

    #[clap(long, default_value = "root", conflicts_with = "config_file")]
    pub mongodb_user: String,

    #[clap(long, default_value = "test", conflicts_with = "config_file")]
    pub mongodb_password: String,

    #[clap(long, default_value = "rvoc", conflicts_with = "config_file")]
    pub mongodb_database: String,

    #[clap(long, default_value = "0.0.0.0", conflicts_with = "config_file")]
    pub api_listen_address: String,

    #[clap(long, default_value = "2374", conflicts_with = "config_file")]
